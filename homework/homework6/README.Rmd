...
Start a separate R Project for Homework 6, as your first step. There are two data files involved in this assignment, called `umaru.csv` and `remission.csv`. Each is available on our github site with the other homework 6 materials.

Note that Homework 6 is worth a total of 100 points. We will scale this assignment so that it takes a more similar weight to the other assignments.
